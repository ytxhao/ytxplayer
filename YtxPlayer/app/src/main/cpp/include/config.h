...
#define FFMPEG_CONFIGURATION "--arch=arm --cpu=cortex-a8 --enable-neon --enable-thumb --enable-openssl --enable-libass --enable-libfreetype --enable-libfribidi --enable-gpl --enable-nonfree --cross-prefix=arm-linux-androideabi- --enable-cross-compile --target-os=android --enable-pic --enable-asm --enable-inline-asm --prefix=/home/yuhao/ytxPlayer/android/contrib/jni/jniLibs --extra-cflags='-O3 -Wall -pipe -std=c99 -ffast-math -fstrict-aliasing -Werror=strict-aliasing -Wno-psabi -Wa,--noexecstack -DANDROID -DNDEBUG -I/home/yuhao/ytxPlayer/android/contrib/jni/jniLibs/include -march=armv7-a -mcpu=cortex-a8 -mfpu=vfpv3-d16 -mfloat-abi=softfp -mthumb' --extra-ldflags='-L/home/yuhao/ytxPlayer/android/contrib/jni/jniLibs/lib -lssl -lcrypto -Wl,--fix-cortex-a8' --sysroot=/home/yuhao/android/ndk/android-ndk-r11b/platforms/android-21/arch-arm/ --pkg-config=pkg-config --enable-shared --disable-static"
#define FFMPEG_LICENSE "nonfree and unredistributable"
#define CONFIG_THIS_YEAR 2016
#define FFMPEG_DATADIR "/home/yuhao/ytxPlayer/android/contrib/jni/jniLibs/share/ffmpeg"
#define AVCONV_DATADIR "/home/yuhao/ytxPlayer/android/contrib/jni/jniLibs/share/ffmpeg"
